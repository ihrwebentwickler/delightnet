...
$opts = array(
	'root'            => '../../../../../public/images',  // path to root directory
	'URL'             => "http://" . $_SERVER["HTTP_HOST"] . "/public/images/", // root directory URL
	'rootAlias'       => 'Hauptverzeichnis',       // display this instead of root directory name
	...
	'uploadDeny'   => array("php","js"),      // mimetypes which not allowed to upload
