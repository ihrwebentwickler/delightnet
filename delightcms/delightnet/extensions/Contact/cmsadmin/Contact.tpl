        ...
        <form action="contactform.html" method="post" enctype="multipart/form-data">
            ...
            <div class="lineboxGui off">
                <div>
                    ...
                    <div class="leftfloat">
                        <ul>
                            <li><input type="text" name="contactform[emaildata][ErrorSenderPart]" value="{CONTACTFORM_EMAIL_ERRORSENDERPART}" /></li>
                        </ul>
                    </div>
                </div>
                <div class="clear">
            ...
            <div class="lineboxGui off">
                <div>
                    ...
                    <div class="leftfloat">
                        <ul>
                            <li><input type="text" name="contactform[emaildata][ConfirmationSiteFileName]" value="{CONTACTFORM_EMAIL_CONFIRMATIONSITEFILENAME}" /></li>
                        </ul>
                    </div>
                </div>
                <div class="clear">
            ...
            <div class="lineboxGui off">
                <div>
                    ...
                    <div class="leftfloat">
                        <ul>
                            <li><input type="text" name="contactform[message][messageStart]" value="{CONTACTFORM_MESSAGE_MESSAGESTART}" /></li>
                            <li><input type="text" name="contactform[message][standardError]" value="{CONTACTFORM_MESSAGE_STANDARDERROR}" /></li>
                            <li><input type="text" name="contactform[message][spamKeyError]" value="{CONTACTFORM_MESSAGE_SPAMKEYERROR}" /></li>
                            <li><input type="text" name="contactform[message][fontColorbyError]" value="{CONTACTFORM_MESSAGE_FONTCOLORBYERROR}" /></li>
                            <li><input type="text" name="contactform[message][styleInputFieldError]" value="{CONTACTFORM_MESSAGE_STYLEINPUFIELDERROR}" /></li>
                        </ul>
                    </div>
                </div>
                <div class="clear">
            ...
            <div class="lineboxGui off">
                <div>
                    ...
                    <div class="leftfloat">
                        <textarea class="middlearea" name="contactform[email][messagetext]">{CONTACTFORM_EMAIL_MESSAGETEXT}</textarea>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="leftfloat textInputLabel">
                ...
                <div>
                    ...
                    <div class="leftfloat">
                        <ul>
                            ...
                            <li><input type="text" name="contactform[captcha][fontSize]" value="{CONTACTFORM_CAPTCHA_FONTSIZE}" /></li>
                            <li><input type="text" name="contactform[captcha][fontColor]" value="{CONTACTFORM_CAPTCHA_FONTCOLOR}" /></li>
                            <li><input type="text" name="contactform[captcha][backgroundColor]" value="{CONTACTFORM_CAPTCHA_BACKGROUNDCOLOR}" /></li>
